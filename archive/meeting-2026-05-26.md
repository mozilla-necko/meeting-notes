...
| --------------------------------------------------------------- | -------- | ---------------------------------------- | -------- | ------------- | ----------------------------------- |
| [1815926](https://bugzilla.mozilla.org/show_bug.cgi?id=1815926) | S2       | URL host parser does not accept * or "   | P1       | valentin      | Just took it                        |
| [2000423](https://bugzilla.mozilla.org/show_bug.cgi?id=2000423) | S3       | FormData parser non-compliant            | P2       | —             | Has patch; needs try push + landing |
...
| [2041443](https://bugzilla.mozilla.org/show_bug.cgi?id=2041443) | S3       | SSL_ERROR_ECH_RETRY_WITHOUT_ECH          | P2       | —             | —                                   |
| [1896460](https://bugzilla.mozilla.org/show_bug.cgi?id=1896460) | S3       | Improve sniffing compat with Blink       | P3       | kershaw       | —                                   |
