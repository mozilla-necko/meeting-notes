...
### Claude Usage Reminder

-   Greg reminded the team that Claude/ChatGPT usage on Mozilla equipment must be for business purposes only.
-   Clarification was made around usage-based resources versus other tooling.
...
**Security-filter validation:** Bugs with values in the **Sec** column have been excluded from the table below.
...
nsStandardURL SanityCheck crash
...
FormData parser preamble compliance
...
Cookie creationDate/lastAccessed restore
...
Exclude spurious document loads telemetry
...
HTTP/3 DoH timeout connection persistence
...
Improve Blink-compatible sniffing
...
Source queue count and status:

* * *

### Closed Fixed (Last Week – Non-Security)

-   2047920 – HTTP auth cache not cleared on clear-origin-attributes-data
-   1815926 – URL host parser does not accept \* or "
-   Additional stability and security-related fixes landed.
