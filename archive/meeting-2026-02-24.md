...
| --------------------------------------------------------------- | -------- | ------------------------------------------------------- | -------- | ------------- | ------------------- |
| [1869403](https://bugzilla.mozilla.org/show_bug.cgi?id=1869403) | S3       | Slow page load with “use system proxy” enabled          | P1       | kershaw       | Will land this week |
...
| [1962817](https://bugzilla.mozilla.org/show_bug.cgi?id=1962817) | S3       | kameleoon.js deprioritization slows render              | P2       | acreskey      | Experiment live     |
| [1963079](https://bugzilla.mozilla.org/show_bug.cgi?id=1963079) | N/A      | Exclude spurious document loads from telemetry          | P2       | —             | —                   |
| [2003616](https://bugzilla.mozilla.org/show_bug.cgi?id=2003616) | S3       | LiteralReader unchecked resize                          | P2       | —             | —                   |
| [2005275](https://bugzilla.mozilla.org/show_bug.cgi?id=2005275) | S3       | NS_IsMainThread assert (notion.so debug)                | P2       | —             | —                   |
...
| [2015000](https://bugzilla.mozilla.org/show_bug.cgi?id=2015000) | S4       | LoadInfo copy constructor missing fields                | P2       | —             | —                   |
| [2015482](https://bugzilla.mozilla.org/show_bug.cgi?id=2015482) | N/A      | BigQuery alerting                                       | P2       | —             | —                   |
| [2017712](https://bugzilla.mozilla.org/show_bug.cgi?id=2017712) | S3       | LNA prompts more eager than Chrome                      | P2       | valentin.gosu | —                   |
