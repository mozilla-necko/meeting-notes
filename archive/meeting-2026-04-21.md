...
| --------------------------------------------------------------- | -------- | --------------------------------------- | -------- | ------------- | ------ |
| [2032433](https://bugzilla.mozilla.org/show_bug.cgi?id=2032433) | S3       | CookieService blocking applink (~825ms) | P1       | valentin.gosu | —      |
| [2000423](https://bugzilla.mozilla.org/show_bug.cgi?id=2000423) | S3       | FormData parser non-compliant           | P2       | —             | —      |
| [1974877](https://bugzilla.mozilla.org/show_bug.cgi?id=1974877) | S3       | WPT failures in cookies/samesite        | P2       | —             | —      |
| [1965087](https://bugzilla.mozilla.org/show_bug.cgi?id=1965087) | S3       | Cookie initialization on restore        | P2       | valentin.gosu | —      |
| [1962316](https://bugzilla.mozilla.org/show_bug.cgi?id=1962316) | S3       | Android VPN bearer issues               | P2       | —             | —      |
| [1963079](https://bugzilla.mozilla.org/show_bug.cgi?id=1963079) | N/A      | Telemetry cleanup (zero-byte loads)     | P2       | —             | —      |
...
| [2032398](https://bugzilla.mozilla.org/show_bug.cgi?id=2032398) | S3       | Remove unused probe mirroring           | P2       | valentin.gosu | —      |
| [1505389](https://bugzilla.mozilla.org/show_bug.cgi?id=1505389) | S3       | Navigation cancels XHR                  | P3       | smayya        | —      |
