...
| --------------------------------------------------------------- | -------- | ----------------------------------------------------------- | -------- | ------------- | ---------------- |
| [1869403](https://bugzilla.mozilla.org/show_bug.cgi?id=1869403) | S3       | Slow page load with “use system proxy” enabled              | P1       | kershaw       | WIP              |
| [2014416](https://bugzilla.mozilla.org/show_bug.cgi?id=2014416) | S3       | H3 connection to google-analytics.com hanging (early data?) | P1       | kershaw       | Landing          |
...
| [1965087](https://bugzilla.mozilla.org/show_bug.cgi?id=1965087) | S3       | Cookie creationDate / lastAccessed initialization           | P2       | edgul         | —                |
| [1962316](https://bugzilla.mozilla.org/show_bug.cgi?id=1962316) | S3       | Android VPN + network change incomplete requests            | P2       | —             | —                |
| [1732512](https://bugzilla.mozilla.org/show_bug.cgi?id=1732512) | S3       | Fetch blocked by form submit (`NS_BINDING_ABORTED`)         | P2       | smayya        | —                |
| [1944288](https://bugzilla.mozilla.org/show_bug.cgi?id=1944288) | S3       | Firefox Android responds to WebSockets in background        | P2       | acreskey      | Starting shortly |
...
| [2014160](https://bugzilla.mozilla.org/show_bug.cgi?id=2014160) | S3       | Cache2 I/O thread 100% CPU (O(n) search)                    | P2       | jesup         | —                |
| [2015000](https://bugzilla.mozilla.org/show_bug.cgi?id=2015000) | S4       | LoadInfo copy constructor missing 4 fields                  | P2       | —             | —                |
| [1896460](https://bugzilla.mozilla.org/show_bug.cgi?id=1896460) | S3       | Improve Blink sniffing compat for text/plain                | P3       | kershaw       | WIP              |
| [2007652](https://bugzilla.mozilla.org/show_bug.cgi?id=2007652) | S4       | Proxy credentials reused across private/regular             | P3       | valentin.gosu | Investigating    |
